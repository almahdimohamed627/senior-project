...
--> statement-breakpoint
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_doctor_id_doctor_profiles_fusion_auth_id_fk" FOREIGN KEY ("doctor_id") REFERENCES "public"."doctor_profiles"("fusion_auth_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "likes" ADD CONSTRAINT "likes_liked_py_users_fusion_auth_id_fk" FOREIGN KEY ("liked_py") REFERENCES "public"."users"("fusion_auth_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_city_cities_id_fk" FOREIGN KEY ("city") REFERENCES "public"."cities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
