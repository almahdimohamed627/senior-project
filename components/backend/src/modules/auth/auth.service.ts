...
export class AuthService {
  // private fusionClient: FusionAuthClientWrapper; // حذفنا التعريف القديم
  ...
  constructor(
    ...
    private fusionClient: FusionAuthClientWrapper // 4. حقن الكلاينت هنا
  ) {
    ...
    // تم إزالة السطر التالي لأنه تم حقنه في الأعلى
    // this.fusionClient = new FusionAuthClientWrapper(...); 
  }
